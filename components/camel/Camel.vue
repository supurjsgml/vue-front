                    ...
                    <div v-show="voOptions">
                        ...
                        <div>
                            ...
                            <div v-show="checkBoxDisplay">
                                ClassName: <input id="ClassName" type="text" name="ClassName" @keyup="convert();" value=""/>&nbsp;
                                PackageName: <input id="PackageName" type="text" name="PackageName" @keyup="convert();" value=""/>&nbsp;
                            </div>
                        </div>
                    </div>
                    <div>
...
const createPackage = () => {
    ...
    if (!checkBoxDisplay.value) {
        ...
        strArray.push('public class ApiBodyDTO {'.concat(bar).concat(bar))
    
        strArray.push(str.replaceAll('@', '    @').replaceAll('private', '    private '))
        strArray.push('}')
